  ...
  <main class="main">
    ...
    <section id="hero" class="hero section dark-background">
      ...
      <div class="container d-flex flex-column align-items-center justify-content-center text-center" data-aos="fade-up" data-aos-delay="100">
        <h2>I am Arun M L</h2>
        <p><span class="typed" data-typed-items="AWS Solutions Architect, Cyber Law Practioner, System Administrator, Sergeant in IAF (Retd), Yuvacharya - Art of living"></span></p>
      </div>
          ...
          <div class="col-lg-5" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="resume-item pb-0">
              ...
              <p align="justify"><em>I served as a Sergeant in Indian Air Force. I put up 20 years of distinguished service, 
                ...
                and AR/VR (Augumented Reality & Virtual Reality) simulators. Also, I have hands on experience in 
                Fighter and Unmanned Aerial Vehicle(UAV) IT Systems</em></p>
             <!--  <ul>
...
<!-------gallery----->
  ...
  <footer id="footer" class="footer accent-background">
    ...
    <div class="container">
      ...
      <div class="copyright text-center ">
        <strong class="px-1 sitename">Website hosted using DOCKER containers</strong>
      </div>
